export const LOCALES = {
  en: {
    ...
    idsHint: "IDs auto-fill when you pick a team above.",
    enterManually: "Enter IDs manually",
    change: "Change",
  ...
  es: {
    ...
    idsHint: "Los IDs se rellenan automáticamente al elegir equipo.",
    enterManually: "Introducir IDs manualmente",
    change: "Cambiar",
  ...
  cat: {
    ...
    grupPhase1: "ID Grup — Fase 1",
    grupPhase2: "ID Grup — Fase 2 (opcional)",
    idsHint: "Els IDs s'omplen automàticament en triar l'equip.",
    enterManually: "Introduir IDs manualment",
    change: "Canviar",
